    ...
    try {
      ...
      if (nextRooms.length > 0) {
        setSelectedRoom((current) => {
          const found = nextRooms.find((room) => room.name === current);
          return found ? current : nextRooms[0].name;
        });
      }
    } catch (error) {
      ...
      <div style={pageWrap}>
        <header style={heroHeader}>
          <div style={heroContent}>
            ...
            <p style={heroText}>
              Premium stage control with server-fed rooms, live host camera, docked screen share,
              bulletin board, chat, and session participants.
            </p>
            ...
            <section style={stagePanel}>
              <div style={stageHeaderRow}>
                <div>
                  ...
                  <h2 style={stageTitle}>{selectedRoom}</h2>
              ...
              <div style={stageWrap}>
                ...
                <div style={stageTopLeftBadges}>
                  <div style={stageGlassBadge}>{selectedRoom}</div>
