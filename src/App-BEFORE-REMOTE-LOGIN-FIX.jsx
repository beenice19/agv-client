              ...
              <div style={stageViewportOuterStyle}>
                ...
                <div style={stageViewportStyle}>
                  ...
                  <div style={styles.audienceCountBadge}>
                    <span style={styles.audienceCountIcon}>👥</span>
            ...
            <section style={styles.panelCard}>
              ...
              <div style={{
                ...
                <div style={{ color: "rgba(236,243,255,0.68)", fontSize: 13, lineHeight: 1.5 }}>
                  Premium room tools, account controls, and Google Drive access — all kept inside a safe cosmetic pass.
                </div>
              </div>
              ...
              <div style={styles.controlGrid}>
                ...
                >
                  ...
                  {preShowTrailerName && (
                    <div style={styles.helperText}>Loaded trailer: {preShowTrailerName} ({preShowTrailerType || "video/mp4"}). Use “Start MP4 Trailer Only” to play the MP4 without the countdown.</div>
                  )}
                ...
                >
                  ...
                  <div style={styles.summaryList}>
                    ...
                    <div style={styles.summaryRow}>
                      ...
                      <strong>{stageContentKind ? stageContentKind.toUpperCase() : "—"}</strong>
                    </div>
                    <div style={styles.summaryRow}>
                ...
                >
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12, marginBottom: 14 }}>
                    ...
                    <div style={{ borderRadius: 16, padding: 12, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
                      ...
                      <div style={{ fontWeight: 800, color: "#f6fbff" }}>{driveSelectedType || "—"}</div>
                    </div>
                  </div>
