...
export default function App() {
  ...
  const showIdleStage = !showExpandedShare && !cameraOn;
  const showDockedShareStandbyStage = shareOn && !shareExpanded && !cameraOn;
              ...
              >
                ...
                {showFloatingCamera ? (
                  <div
                    style={{
                      position: "absolute",
                      right: showExpandedShare ? "18px" : "18px",
                      bottom: showExpandedShare ? "18px" : "18px",
                      width: "190px",
                      aspectRatio: "4 / 5",
                      borderRadius: "22px",
                      overflow: "hidden",
