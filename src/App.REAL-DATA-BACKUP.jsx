      ...
      <div style={pageWrap}>
        <header style={heroHeader}>
          <div style={heroContent}>
            ...
            <p style={heroText}>
              Premium stage control with rooms, live host camera, docked screen share, bulletin board,
              chat, and session participants.
            </p>
        ...
        <section style={mainGrid}>
          <aside style={sidebarPanel}>
            <div style={panelHeaderRow}>
              ...
              <div style={miniBadge}>{liveCount} total</div>
            </div>
            ...
            <section style={lowerGrid}>
              <div style={contentPanel}>
                <div style={panelHeaderRow}>
                  ...
                  <div style={miniBadge}>{messages.length} messages</div>
                </div>
