...
export default function App() {
  ...
  const selectedRoomObject = rooms.find((room) => Number(room.id) === Number(selectedRoomId)) || null;
      ...
      <div style={pageWrap}>
        <header style={heroHeader}>
          <div style={heroContent}>
            ...
            <p style={heroText}>
              Premium stage control with real host and viewer modes, private rooms,
              room admin tools, chat, bulletin board, live host camera, docked screen share,
              and participants.
            </p>
            ...
            {canUseAdminControls ? (
              ...
              <div style={viewerInfoPanel}>
                ...
                <div style={smallMutedText}>
                  Viewer mode can attend rooms, unlock private rooms, read bulletin updates,
                  and use chat. Room admin and media controls are host-only.
                </div>
              </div>
            )}
          </aside>
                ...
                {selectedRoomBlocked ? (
                  <div style={privateGateScreen}>
                    ...
                    <div style={privateGateForm}>
                      ...
                      <button
                        type="button"
                        onClick={handleUnlockPrivateRoom}
                        style={buttonPrimary}
                      >
                        Unlock Room
                      </button>
                  ...
                  <div style={stageInfoScreen}>
                    ...
                    <div style={stageInfoText}>
                      {isHost
                        ? "Click Start Camera for webcam preview or Start Share to place your screen into the dock box."
                        : "Viewer mode is active. Watch the stage, chat, and unlock private rooms when needed."}
                    </div>
              ...
              <div style={contentPanel}>
                ...
                <div style={chatComposer}>
                  ...
                  <button
                    ...
                    style={buttonPrimary}
                    disabled={chatSending || selectedRoomBlocked}
                  >
